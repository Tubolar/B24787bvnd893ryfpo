...
bot.on("message", async message => {
    if(message.author.bot) return;
const filter = [/превет/i, "привт", "пожалуста", "пажалуйста", "сколька", "кагд", "довно", "чтото", "ктото", "почемуто", "зачемто", "менут", "ришил", "пака", "минемум", "оранджевый", "коекто", "фиалетовый", "грамата", "граматно", "отенки" ,"дабавить" ,"крута" ,"хател" ,"менятся" ,"здел", "остановитса", "сибе", "што", "хто", "воопще", "вапще", "дла", "праверки", "счем", "скем", "пач", "щя","шя", "щто", "обьявления", "падъезд", "пасажир", "позал", "удол", "тса", "всети", "активо", "проста", "не можно", "класн", "цто", "симва", "апрос", "чят", "дастал", "упомину", "дискорт", "харош", "ща", "помоч","вап", "апас", "чо", "чё", "панят", "сматр", "пригло", "девач", "комманды", "даеш", "естествено", "ешё", "ищё", "чево", "чиво", "заприщены", "запрещенны", "сылку", "силку", "поседи", "принцепе", "прекрепил", "чтоли", "чтали", "юнность", "дивя", "тристо", "адин", "четыри", "пж", "нуда", "сроботал", "астав", "видио", "видил", "дич", "временый", "тварит", "вазм", "придл", "панимаешь", "пастоянно", "постаянно", "постояно", "тирпеть", "восимь", "девить", "мусарку", "проффессионалом", "нечайно","ничайно", "ничяяно", "нечяяно", "пашёл", "пошо", "наверно", "видиш", "скоко", "раскажите", "ешо"];
