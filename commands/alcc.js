...
module.exports.run = async (bot, message, args) => {
    ...
    function cRole() {
        var randomA = '#'+(Math.random()*0xFFFFFF<<0).toString(16);
        var randomT = '#'+(Math.random()*0xFFFFFF<<0).toString(16);
        var randomD = '#'+(Math.random()*0xFFFFFF<<0).toString(16);
        var randomR = '#'+(Math.random()*0xFFFFFF<<0).toString(16);
        var randomB = '#'+(Math.random()*0xFFFFFF<<0).toString(16);
